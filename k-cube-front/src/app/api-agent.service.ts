...
export class ApiAgentService {
  ...
  relationship: crudResources = new crudResources(this, "relatipnship", true, true, true, true, false)
  relationships: searchResources = new searchResources(this, "relatipnships")
